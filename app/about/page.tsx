      ...
      <nav className="relative z-20 w-full px-8 py-6">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          <Link href="/" className="flex items-center">
            <img src="/arvintech-logo-white.png" alt="arvintech" className="h-8 w-auto" />
          </Link>
      ...
      <div className="max-w-6xl mx-auto px-8 py-16">
        ...
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 md:p-12 mb-16 animate-on-scroll">
          ...
          <div className="space-y-6 text-slate-300 text-lg leading-relaxed">
            <p>
              <span className="text-emerald-400 font-semibold">arvintech</span> represents a fundamental shift in how we
              approach artificial intelligence. We believe in collaboration, not replacement. Our philosophy centers on
              the courage to unlearn outdated paradigms and relearn new possibilities—measuring intelligence not by what
              machines can do alone, but by what humans and AI can achieve together.
            </p>
            <p>
              This is about possibility. This is about preparation. This is about discovering new, exciting ways to live
              human lives amplified. As a Bay Area-based IT consulting and digital innovation firm with a distributed
              support team in Manila, we don't just provide technology solutions—we forge partnerships that expand what
              it means to be human in an AI-enhanced world.
            </p>
            <p>
              Our approach combines the reliability of proven IT infrastructure with the transformative power of
              collaborative intelligence. Whether you're a growing business reimagining operational possibilities or an
              independent author exploring new creative frontiers, we partner with you to harness technology that
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <p className="text-slate-300 leading-relaxed">
                ...
                technology ecosystem works as one cohesive Intelligence Amplification platform. No siloed solutions—just
        ...
        <div className="text-center bg-slate-800/50 rounded-2xl p-8 md:p-12 animate-on-scroll">
          ...
          <p className="text-lg text-slate-300 mb-8 max-w-3xl mx-auto">
            Let's explore how our Intelligence Amplification approach can transform your business, creative projects, or
